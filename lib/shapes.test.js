...
describe.each([
    ...
    test('Outline (no fill) color is set correctly', () => {
        ...
        expect(t.render()).toEqual(`<polygon points="150, 18 244, 182 56, 182" stroke="${color}" stroke-width="10" fill="transparent" />`)
    })
})
...
describe.each([
    ...
    test('Outline (no fill) color is set correctly', () => {
        ...
        expect(c.render()).toEqual(`<circle cx="150" cy="100" r="80" stroke="${color}" stroke-width="10" fill="transparent" />`);
    })
})
...
describe.each([
    ...
    test('Outline (no fill) color is set correctly', () => {
        ...
        expect(s.render()).toEqual(`<rect x="70" y="20" width="160" height="160" stroke="${color}" stroke-width="10" fill="transparent" />`)
    })
})